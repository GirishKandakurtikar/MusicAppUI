        ...
        AlertDialog(
            ...
            text = { 
                ...
                verticalArrangement = Arrangement.Center){
                    androidx.compose.material.TextField(value = "", onValueChange = {},
                        modifier = Modifier.padding(16.dp), label = {Text("Email")})
                    androidx.compose.material.TextField(value = "", onValueChange = {},
                        modifier = Modifier.padding(8.dp), label = {Text("Password")})
                }
            },
